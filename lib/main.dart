    ...
    return MaterialApp(
      ...
      theme: theme.copyWith(
        ...
        textTheme: textTheme.copyWith(
          ...
          titleSmall: const TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w600),
          titleMedium: const TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w600),
          titleLarge: const TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.w600),
        ),
      ),
